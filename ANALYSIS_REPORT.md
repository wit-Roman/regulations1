...
| **Технолог** | Анализ контролек после изменения параметров заказа, корректировка настроек |
| **Мастер смены** | Контроль критических ошибок (красные контрольки), блокировка дальнейших операций при наличии ошибок |

*Примечание: Детализация ролей будет уточнена позже*
