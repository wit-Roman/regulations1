...
7.  **ISO 9000** - стандарт, ориентированный на управление качеством, который содержит принципы и критерии, направленные на повышение эффективности и результативности процессов в организациях.
   
8.  **BS 7799** , также известный как ISO/IEC 17799, является стандартом для управления информационной безопасностью. Он охватывает методы и меры защиты информации, включая управление рисками и инцидентами.
    
9.  **PRINCE2** (Projects IN Controlled Environments) — методология управления проектами, которая обеспечивает структурированный подход к управлению проектами, позволяет четко определить роли и обязанности участников проекта.
