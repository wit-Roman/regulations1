...
| 2 | Приобретение инструментов мониторинга      | Конфигурация систем мониторинга с учетом установленных ранее требований.                    | Настроенные инструменты мониторинга.                | Установка и настройка инструментов мониторинга на сервере. |
| 3 | Настройка инструментов мониторинга      | Конфигурация систем мониторинга с учетом установленных ранее требований.                    | Настроенные инструменты мониторинга.                | Установка и настройка инструментов мониторинга на сервере. |
